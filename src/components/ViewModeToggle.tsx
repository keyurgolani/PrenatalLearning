        ...
        return (
          <React.Fragment key={value}>
            ...
            <button
              ...
              className={`
                flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 animate-gentle-bounce animate-click ${isHeader ? 'focus-ring-light' : 'focus-ring'}
                ${isActive ? 'shadow-sm' : ''}
              `}
              style={
                isActive
