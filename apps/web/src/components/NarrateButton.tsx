 ...
 * @deprecated Use useAudio().stopAudio() instead
 */
        ...
        {displayDuration > 0 && (
          <div
            ...
            onKeyDown={(e) => {
              if (e.key === 'ArrowRight') {
                e.preventDefault();
                seekTo(Math.min(displayDuration, currentTime + displayDuration * 0.05));
              } else if (e.key === 'ArrowLeft') {
                e.preventDefault();
                seekTo(Math.max(0, currentTime - displayDuration * 0.05));
              }
            }}
            role="slider"
